...
import de.tstieh.stoneintelligence.stoneai.pipeline.IngestReport;
 ...
 * {@code java -cp /app/app.jar -Dloader.main=de.tstieh.stoneintelligence.worker.ingest.TrialRun
