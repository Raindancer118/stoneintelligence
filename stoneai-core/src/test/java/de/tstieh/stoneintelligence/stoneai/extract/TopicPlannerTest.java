...
import de.tstieh.stoneintelligence.stoneai.source.Page;
    ...
    void should_excerptTheWholeOfAVeryLongDocument() {
        ...
        for (int i = 0; i < 300; i++) {
            chunks.add(new Chunk(i, "Abschnitt " + (i + 1) + " " + "Inhalt ".repeat(1_400),
                    new de.tstieh.stoneintelligence.stoneai.chunk.Provenance("Buch", Path.of("/tmp/Buch.pdf"), i * 3 + 1, null, i * 3 + 3)));
        }
